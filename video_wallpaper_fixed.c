/*
 * Video Wallpaper Engine - FIXED VIDEO RENDERING
 * Uses top-level window instead of child window for proper video display
 * Compiled with MSVC for proper Media Foundation support
 *
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    printf("\n=== Video Wallpaper - FIXED VIDEO RENDERING ===\n\n");
...
HWND create_wallpaper_window(HINSTANCE hInstance) {
    ...
    // KEY FIX: Create window as TOP-LEVEL window (not child of Progman)
    // This allows Media Foundation to render video properly
    // Child windows have clipping that prevents video display
